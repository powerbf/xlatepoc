...
enum tile_main_type
{
    ...
    TILE_WPN_HUNTING_SLING_2,
    TILE_WPN_FUSTIBALUS,
    TILE_WPN_FUSTIBALUS_1,
    TILE_WPN_FUSTIBALUS_2,
    TILE_WPN_SHORTBOW,
    TILE_WPN_SHORTBOW_1,
    TILE_WPN_SHORTBOW_2,
    TILE_WPN_LONGBOW,
    ...
    TILE_BRAND_ARM_LAST = TILE_BRAND_ARM_CLOUD_IMMUNE,
    TILE_WAND_OFFSET,
    ...
    TILE_WAND_CLOUDS,
    TILE_WAND_SCATTERSHOT,
    TILE_WAND_ID_LAST = TILE_WAND_SCATTERSHOT,
    TILE_FOOD_RATION,
    ...
    TILE_POT_LIGNIFY,
    TILE_POT_REMOVEME9,
    TILE_POT_ID_LAST = TILE_POT_REMOVEME9,
    TILE_BOOK_OFFSET,
